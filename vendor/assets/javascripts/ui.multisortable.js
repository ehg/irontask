...
$.widget("ui.multisortable", $.extend({}, $.ui.sortable.prototype, {
	...
	_createHelper: function(event) {
		...
		if (this.currentItem.hasClass('ui-multisort-grouped')) {
			var helper = $(this.currentItem).add($(this.currentItem).siblings('.ui-multisort-grouped').clone(true)).clone(true);
			...
			var helper = $.isFunction(o.helper) ? $(o.helper.apply(this.element[0], [event, this.currentItem])) : (o.helper == 'clone' ? this.currentItem.clone(true, true) : this.currentItem);
